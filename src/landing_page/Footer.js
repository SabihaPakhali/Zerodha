    ...
    return (  
      ...
      <div className='container border-top mt-5' 
        ...
        <div className='row mt-5'> 
            <div className='col '> 
                < img src="media/images/logo.svg" style={{ width: "50%"}} /> <br/>
...
<div>
      ...
      <a href=" https://www.linkedin.com/company/zerodha" target="_blank">
        <i className="fa-brands fa-linkedin fa-2x"></i>
      </a>{' '}
      <a href="https://www.youtube.com/@zerodhaonline" target="_blank">
        <i className="fa-brands fa-youtube fa-2x"></i>
      </a>{' '}
      <a href=" https://t.me/zerodhain" target="_blank">
